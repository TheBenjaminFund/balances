...
const JWT_SECRET = process.env.JWT_SECRET || 'rmECc0lvPgjSS1tnaef3ihqnYHj1cs2zifOG-kyR-44';
const ADMIN_EMAIL = process.env.ADMIN_EMAIL || 'matthew.benjamin@thebenjaminfund.org';
const ADMIN_PASSWORD = process.env.ADMIN_PASSWORD || 'VcTlAQfIVXIWSCWGrS5Cww';
...
// Static files (widget + minimal admin UI)
